...
# a) Extract "Pokemon" from the 5th game's name (index 4) using string indexing
game_name = video_game_sales[4][NAME]
pokemon_word = game_name[0:7]
print(pokemon_word)

# b) Clean messy game names: strip whitespace and lowercase
messy_names = ['  Wii Sports  ', 'TETRIS', '  mario kart WII']
for name in messy_names:
    cleaned = name.strip().lower()
    print(cleaned)

# c) Formatted summary of the #1 game using an f-string
