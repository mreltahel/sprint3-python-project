...
# (game count, column count, dataset name) is fixed, descriptive information
# that shouldn't change during the program's execution. Tuples are immutable,
# so using one protects these values from being accidentally modified,
# and signals to anyone reading the code that this data is meant to stay constant.
