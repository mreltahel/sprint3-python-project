...
# Game added in Task 3 (carried forward so this file matches the project's dataset state)
...
platform_games = filter_by_genre(video_game_sales)  # uses default 'Platform'
racing_games = filter_by_genre(video_game_sales, 'Racing')  # explicit genre
